...
from labels import create_churn_labels, validate_labels, analyze_mismatches
...
class TestChurnLabels:
    ...
    def sample_transactions(self):
        ...
        data = [
            ...
            {"msno": "user1", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            
            # User 2: Renews - expires 2017-02-15, renews on 2017-02-20 (5 days later)
            {"msno": "user2", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user2", "membership_expire_date": "20170320", "transaction_date": "20170220", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            
            # User 3: Edge case - renews on exactly day 30 (should not be churn)
            {"msno": "user3", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user3", "membership_expire_date": "20170320", "transaction_date": "20170317", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
             
            # User 4: Late renewal (day 31 - should be churn)
            {"msno": "user4", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user4", "membership_expire_date": "20170320", "transaction_date": "20170318", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
             
            # User 5: Cancellation within window (should still be churn)
            {"msno": "user5", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user5", "membership_expire_date": "20170320", "transaction_date": "20170220", 
             "payment_plan_days": 0, "is_auto_renew": 0, "is_cancel": 1},
        ]
    ...
    def test_edge_case_same_day_renewal(self):
        ...
        tx_data = [
            {"msno": "user1", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user1", "membership_expire_date": "20170320", "transaction_date": "20170215", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
        ]
    ...
    def test_multiple_expirations_per_user(self):
        ...
        tx_data = [
            ...
            {"msno": "user1", "membership_expire_date": "20170115", "transaction_date": "20170101", 
             "payment_plan_days": 15, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user1", "membership_expire_date": "20170215", "transaction_date": "20170116", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
    ...
    def test_malformed_dates(self):
        ...
        tx_data = [
            {"msno": "user1", "membership_expire_date": "20170215", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user2", "membership_expire_date": None, "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
            {"msno": "user3", "membership_expire_date": "invalid", "transaction_date": "20170101", 
             "payment_plan_days": 30, "is_auto_renew": 0, "is_cancel": 0},
        ]
